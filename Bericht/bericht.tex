...
\begin{itemize} \label{launch}
	\item \texttt{roslaunch boot usv.launch params\_file:=<path\_to\_file.yaml>}
\end{itemize}

\lstinputlisting[label={params}, caption={Parameter für den Start eines Szenarios}, language=yaml]{../usv_params.yaml}
...
\begin{tabular}[t]{|c| c| c| c|}
	...
	origin&start& & \\
	lat, lon & lat, lon & height x width & dist\\
	\hline
	-30.048638,-51.236690&-30.047311,-51.234663&15 x 15&5\\
	\hline
\end{tabular}
\end{center}
